...
load_mnist <- function() {
  ...
  train$y <<- load_label_file('C:/Users/Rexx/Documents/MNIST-data/train-labels-idx1-ubyte')
  test$y <<- load_label_file('C:/Users/Rexx/Documents/MNIST-data/t10k-labels-idx1-ubyte')  
}
